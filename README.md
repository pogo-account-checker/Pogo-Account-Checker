...
### APK
You can get the APK by directly downloading it from Github (`apk/pogo-account-checker.apk`), or by building it yourself. You have to take some additional steps if you want to build the APK yourself:
