...
## Requirements
* Rooted Android device with Android 5.0 - 9.0 and the language set to english.
...
You can get the APK [here](https://github.com/pogo-account-checker/Pogo-Account-Checker/blob/master/apk/pogo-account-checker.apk).
## Checking accounts
